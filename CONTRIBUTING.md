...
## Report bugs using Github's [issues](https://github.com/Rishit-dagli/Greenathon-Plant-AI/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/Rishit-dagli/Greenathon-Plant-AI/issues); it's that easy!
